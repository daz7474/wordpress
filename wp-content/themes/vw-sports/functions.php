...
function vw_sports_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wordpress-sports-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-sports' ) .'</a></span>';
	echo '</div>';
}
...
define('VW_SPORTS_BUY_NOW',__('https://www.vwthemes.com/products/wordpress-sports-theme/','vw-sports'));
...
define('VW_SPORTS_CREDIT',__('https://www.vwthemes.com/products/free-wordpress-sports-theme/','vw-sports'));
