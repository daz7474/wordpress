...
function vw_sports_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'vw_sports_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/wordpress-sports-theme/">GET PRO</a>','vw-sports'),
		'panel' => 'vw_sports_homepage_panel'
	) );
	...
	$wp_customize->add_section('vw_sports_services',array(
		...
		'description' => __('For more options of game section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/wordpress-sports-theme/">GET PRO</a>','vw-sports'),
		'panel' => 'vw_sports_homepage_panel',
	));
	...
	$wp_customize->add_section('vw_sports_footer',array(
		...
		'panel' => 'vw_sports_homepage_panel',
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/wordpress-sports-theme/">GET PRO</a>','vw-sports'),
	));
    ...
    $wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_footer_hide_show',array(
      ...
      'section' => 'vw_sports_footer'
   	...
   	// font size
	$wp_customize->add_setting('vw_sports_button_footer_font_size',array(
		'default'=> 30,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','vw-sports'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('vw_sports_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','vw-sports'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('vw_sports_button_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'vw_sports_sanitize_choices'
	));
	$wp_customize->add_control('vw_sports_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','vw-sports'),
		'choices' => array(
      'Uppercase' => __('Uppercase','vw-sports'),
      'Capitalize' => __('Capitalize','vw-sports'),
      'Lowercase' => __('Lowercase','vw-sports'),
	...
	$wp_customize->add_setting('vw_sports_footer_heading_weight',array(
        'default' => 600,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_sports_sanitize_choices'
	));
	$wp_customize->add_control('vw_sports_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','vw-sports'),
        'section' => 'vw_sports_footer',
        'choices' => array(
        	'100' => __('100','vw-sports'),
            '200' => __('200','vw-sports'),
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new VW_Sports_Customize_Section_Pro( $manager,'vw_sports_go_pro', array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/wordpress-sports-theme/'),
		) )	);
