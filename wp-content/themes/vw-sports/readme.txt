...
VW Sports will give a flying start to your sports or sports club website as it is geared towards any kind of sports-related site. You get an absolutely sophisticated online appearance with this theme’s responsive as well as mobile-friendly and expertly crafted design that hardly needs to be modified. 
...
= 0.2.1 =
* Changed responsive settings conditions.
* Added show/hide scroll to top in customizer.
* Added scroll to top alignment option in customizer.
* Resolved error of menu top space remain when we scrolling it in admin bar.
* Added conditions when slider is off.
* Added post formats.
* Added footer credit link.
* Added customizer doc link in customizer.
* Changed boostrap classes.
...
* Removed woocommerce product addon plugin recommendation from tgm file.
...
= 0.4.5 =
* Done block pattern editor image css.
...
= 0.5 =
* Added blog post layout option in customizer.
...
= 0.5.2 =
* Added go pro button in slider section in customizer.
...
* Added go pro button in game and footer section in customizer.
* Updated language folder.
...
* Added blog page button font size, text transform, padding option in customizer.
...
* Added option for date, author, comment, time and tags in single post layout.
...
= 0.5.8 =
* Added menus text transform in customizer.
...
* Resolve header image issue.
* Added header background color in menus setting in customizer.
* Added header image background position in menus setting in customizer.
* Added 404 , no result and social icon setting for the in customizer.
* Added css for 404 page.
* Added meta separator in the grid layout for the customizer.
* Added excerpt length in the grid layout for the customizer.
* Update pot file.
...
= 0.6.9 =
* Added show / hide blog pagination option in blog post.
* Added blog pagination option in blog post.
...
* Added button icon for grid layout.
* Added excerpt suffix in grid post.
* Added css for get started in woocommerce products addons tab.
* Added three column and four column sidebar layout option in blog post.
* Update pot file.
...
* Added grid post content option in grid layout.
* Added featured image border radius option in grid layout.
* Added featured image box shadow option in grid layout.
* Update pot file.
...
= 0.7.4 =
* Resolved get started plugin activation error.
* Slider setting on in responsive media.

= 0.7.5 =
* Added slider button link option.
* Resolved error for slider heading in responsive media.
* Added cart and checkout page css.
* Added menu hover top border.
* Update pot file.

= 0.7.6 =
* Added css for view cart button.
* Resolved error for cart page product description.
* Changed rtl css.
...
VW Sports WordPress Theme, Copyright 2021 VWThemes
VW Sports is distributed under the terms of the GNU GPL.
...
* Anton *
* Source : https://fonts.google.com/specimen/Anton?query=Anton
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1409339

Game Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/989950

Game Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/780570

Game Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/757702

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-sports/
